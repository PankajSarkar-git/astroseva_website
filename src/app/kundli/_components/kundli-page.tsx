          ...
          <div className="flex flex-col min-h-screen items-center justify-center text-center px-4 py-16 sm:py-24 h-full w-full bg-gradient-to-b from-background to-muted">
            <div className="max-w-2xl">
              ...
              <p className="text-muted-foreground text-base sm:text-lg mb-8">
                ...
                astrological charts. Start with your Birth Chart, Navamsha
                Chart, and Akshvedansha Chart.
              </p>
              <Button
                size="lg"
        ...
        {formSubmitted && (
          <>
            ...
            <div className="flex items-center justify-between border-b border-border px-4">
              ...
              <Button
                size="sm"
                className="ml-4 px-4 py-2 rounded-md text-white bg-button-primary hover:bg-button-secondary shadow-md"
                onClick={() => setShowForm(true)}
              >
                Edit Details
              </Button>
